...
■ビルド方法
本バージョンは、32bit 版は WDK 6001.18002、64bit 版は WDK 7.1.0 を使って
ビルドされています。（WDK には MFC も含まれています。）

Win2k 以降で使える 32bit 実行ファイルをビルドする場合、スタートメニューから
...
を選択してください。Win2k のリリースビルド用の環境が開きますので、
