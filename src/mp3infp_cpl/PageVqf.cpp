...
IMPLEMENT_DYNCREATE(CPageVqf, CPropertyPage)
...
void CPageVqf::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPageVqf)
...
BEGIN_MESSAGE_MAP(CPageVqf, CPropertyPage)
	//{{AFX_MSG_MAP(CPageVqf)
...
void CPageVqf::OnDefault() 
{
	//デフォルト値を設定
	m_bPropEnable = TRUE;
	m_bInfotipEnable = TRUE;
	m_strInfotipFormat.LoadString(IDS_DEF_INFOTIP_VQF_FORMAT);
...
void CPageVqf::OnSetCheck()
{
	SetCheck();
	SetModified();
}

void CPageVqf::SetCheck()
{
	//Infotip有効
